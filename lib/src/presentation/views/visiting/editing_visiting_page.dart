...
class EditingVisitingPage extends StatefulWidget {
  const EditingVisitingPage({
    super.key,
    required this.isPlannedVisiting,
    required this.isEditing,
  });

  static const String routeName = '/editing_visiting_page';

  final bool isPlannedVisiting;
  final bool isEditing;

  @override
  State<EditingVisitingPage> createState() => _EditingVisitingPageState();
}

class _EditingVisitingPageState extends State<EditingVisitingPage> {
  @override
          ...
          SafeArea(
              ...
              child: Container(
                  ...
                  child: OutlinedButton(
                    onPressed: () async {
                      ...
                      if (isOke != null) {
                        if (isOke) {
                          ...
                          Navigator.pushNamed(context, CheckOutPage.routeName, arguments: "Realisasi Visiting").then((value) {
                            if (value != null) {
                              if (value == true) {
                    ...
                    child: Text(
                      widget.isEditing ? "Save" : "Konfirm Realisasi",
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 16,
