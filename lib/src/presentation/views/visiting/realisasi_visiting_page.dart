...
class RealisasiVisitingPage extends StatefulWidget {
  static const String routeName = '/realisasi_visiting_page';
  const RealisasiVisitingPage({super.key, required this.isPlannedVisiting});

  final bool isPlannedVisiting;

  @override
  State<RealisasiVisitingPage> createState() => _RealisasiVisitingPageState();
}

class _RealisasiVisitingPageState extends State<RealisasiVisitingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Entry Realisasi Visiting"),
      ),
      body: Column(
        children: [
          Expanded(
