...
class SetoranTunaiPage extends StatefulWidget {
  static const String routeName = '/setoran_tunai_page';

  const SetoranTunaiPage({super.key});

  @override
  State<SetoranTunaiPage> createState() => _SetoranTunaiPageState();
}

class _SetoranTunaiPageState extends State<SetoranTunaiPage> {
